...
# Info
urlSupportedCoins = "https://open-api-v3.coinglass.com/api/futures/openInterest/ohlc-history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlSupportedExchanges = "https://open-api-v3.coinglass.com/api/futures/supported-exchange-pairs"

# Open Interest
urlOIOHLC = "https://open-api-v3.coinglass.com/api/futures/openInterest/ohlc-history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlOIHistory = "https://open-api-v3.coinglass.com/api/futures/openInterest/ohlc-aggregated-history?symbol=LINK&interval=1d&limit=4500&startTime=1652342400"
# urlExchangeListOILINK = "https://open-api-v3.coinglass.com/api/futures/openInterest/exchange-list?symbol=LINK" no time column

# Funding
urlFunding = "https://open-api-v3.coinglass.com/api/futures/fundingRate/ohlc-history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlFundingHistoryOIWeight = "https://open-api-v3.coinglass.com/api/futures/fundingRate/oi-weight-ohlc-history?symbol=LINK&interval=1d&limit=4500"
urlFundingHistoryVolWeight = "https://open-api-v3.coinglass.com/api/futures/fundingRate/vol-weight-ohlc-history?symbol=LINK&interval=1d&limit=4500"

# Liquidation
urlLiquidation = "https://open-api-v3.coinglass.com/api/futures/liquidation/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlLiquidationHistory = "https://open-api-v3.coinglass.com/api/futures/liquidation/aggregated-history?symbol=LINK&interval=1d&limit=4500"
# urlLiquidationCoinList = "https://open-api-v3.coinglass.com/api/futures/liquidation/coin-list?symbol=LINK&range=1d"
# urlLiquidationExchangeList = "https://open-api-v3.coinglass.com/api/futures/liquidation/exchange-list?symbol=LINK&range=1d"

# Long/Short
urlGlobalLongShort = "https://open-api-v3.coinglass.com/api/futures/globalLongShortAccountRatio/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlAccountLongShort = "https://open-api-v3.coinglass.com/api/futures/topLongShortAccountRatio/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urltopLongShortPositionRatio = "https://open-api-v3.coinglass.com/api/futures/topLongShortPositionRatio/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urlaggregatedTakerBuySellVolumeRatio = "https://open-api-v3.coinglass.com/api/futures/aggregatedTakerBuySellVolumeRatio/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
urltakerBuySellVolume = "https://open-api-v3.coinglass.com/api/futures/takerBuySellVolume/history?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
# urltakerBuySellVolume = "https://open-api-v3.coinglass.com/api/futures/takerBuySellVolume/exchange-list?exchange=Binance&symbol=LINKUSDT&interval=1d&limit=4500"
...
urlLINKProfitable = "https://open-api-v3.coinglass.com/api/index/bitcoin-profitable-days"
...
# Option
urlOption = "https://open-api-v3.coinglass.com/api/option/info?symbol=LINK"
...
# If Crypto/data/coinglass_LINK.csv not found, create new df, otherwise append
if not os.path.exists('Crypto/data/coinglass_LINK.csv'):
    df_merged.to_csv('Crypto/data/coinglass_LINK.csv', index=False)
else:
    df_merged.to_csv('Crypto/data/coinglass_LINK.csv', mode='a', header=False, index=False)
