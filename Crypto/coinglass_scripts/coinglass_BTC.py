...
if not os.path.exists('Crypto/data/coinglass_BTC.csv'):
    df_merged.to_csv('Crypto/data/coinglass_BTC.csv', index=False)
else:
    df_merged.to_csv('Crypto/data/coinglass_BTC.csv', mode='a', header=False, index=False)
