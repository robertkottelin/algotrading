...
urlOHLC = "https://open-api.coinglass.com/public/v2/indicator/price_ohlc?ex=Binance&pair=ETHUSDT&interval=h4&limit=4500"
urlOI = "https://open-api.coinglass.com/public/v2/indicator/open_interest_ohlc?ex=Binance&pair=ETHUSDT&interval=h4&limit=4500"
urlFunding = "https://open-api.coinglass.com/public/v2/indicator/funding_avg?symbol=ETH&interval=h4&limit=4500"
urlLiquidation = "https://open-api.coinglass.com/public/v2/indicator/liquidation_pair?ex=Binance&pair=ETHUSDT&interval=h4&limit=4500"
urlLongShort = "https://open-api.coinglass.com/public/v2/indicator/top_long_short_position_ratio?ex=Binance&pair=ETHUSDT&interval=h4&limit=4500"
...
existing_df = pd.read_csv('Crypto/data/coinglass_ETH.csv')

new_rows = merged_df[~merged_df['t'].isin(existing_df['t'])]

# Append new rows to the CSV file, if there are any
if not new_rows.empty:
    new_rows.to_csv('Crypto/data/coinglass_ETH.csv', mode='a', header=False, index=False)
