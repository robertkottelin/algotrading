...
urlOHLC = "https://open-api.coinglass.com/public/v2/indicator/price_ohlc?ex=Binance&pair=AVAXUSDT&interval=h4&limit=4500"
urlOI = "https://open-api.coinglass.com/public/v2/indicator/open_interest_ohlc?ex=Binance&pair=AVAXUSDT&interval=h4&limit=4500"
urlFunding = "https://open-api.coinglass.com/public/v2/indicator/funding_avg?symbol=AVAX&interval=h4&limit=4500"
urlLiquidation = "https://open-api.coinglass.com/public/v2/indicator/liquidation_pair?ex=Binance&pair=AVAXUSDT&interval=h4&limit=4500"
urlLongShort = "https://open-api.coinglass.com/public/v2/indicator/top_long_short_position_ratio?ex=Binance&pair=AVAXUSDT&interval=h4&limit=4500"
...
# Display the first few rows
print("Liquidation:", liquidation_data)
...
file_path = 'Crypto/data/coinglass_AVAX.csv'
